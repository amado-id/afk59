	...
	<div class="contacts-wrapper">
		<div class="row">
			<div class="<?=($bUseFeedback ? 'col-md-4' : 'col-md-6')?>">
				<table>
					<tr>
						<td align="left" valign="top"><i class="fa big-icon s45"><?=CAllcorp2::showIconSvg("address", SITE_TEMPLATE_PATH."/images/svg/Addres_black.svg");?></i></td>
			...
			<div class="<?=($bUseFeedback ? 'col-md-3' : 'col-md-3')?>">
				<table>
					<tr>
						<td align="left" valign="top"><i class="fa big-icon s45"><?=CAllcorp2::showIconSvg("phone", SITE_TEMPLATE_PATH."/images/svg/Phone_black.svg");?></i></td>
			...
			<div class="<?=($bUseFeedback ? 'col-md-3' : 'col-md-3')?>">
				<table>
					<tr>
						<td align="left" valign="top"><i class="fa big-icon s45"><?=CAllcorp2::showIconSvg("email", SITE_TEMPLATE_PATH."/images/svg/Email.svg");?></i></td>
