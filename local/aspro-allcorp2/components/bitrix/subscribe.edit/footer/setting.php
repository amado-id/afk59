...
<form action="<?=SITE_DIR.$arParams["PAGE"]?>" method="post" class="subscribe-form">
	...
	<input type="submit" name="Save" class="btn btn-default btn-md subscribe-btn" value="<?echo GetMessage("ADD_USER");?>" onclick="ga('send', 'event', 'lead', 'podpiska');yaCounter31109961.reachGoal('podpiska');" />
