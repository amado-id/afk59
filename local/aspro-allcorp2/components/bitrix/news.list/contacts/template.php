								...
								<tr class="item" id="<?=$this->GetEditAreaId($arItem['ID'])?>">
									...
									<td class="hidden-xs" <?=(($arResult['ITEMS_HAS_IMG'] && !$imageSrc) ? 'colspan=2' : '');?>>
										...
										<?if($arItem['PROPERTIES']['EMAIL']['VALUE']):?>
											<div class="muted">
												<span class="icons-text schedule grey s25"><i class="fa"><?=CAllcorp2::showIconSvg("email colored", SITE_TEMPLATE_PATH."/images/svg/Email.svg");?></i> <a href="mailto:<?=$arItem['PROPERTIES']['EMAIL']['VALUE'];?>" class="text"><?=$arItem['PROPERTIES']['EMAIL']['VALUE'];?></a></span>
											</div>
										<?endif;?>
									</td>
										...
										<div class="row">
											<div class="col-xs-8">
												<div class="titles-block">
													...
													<?if($arItem['PROPERTIES']['EMAIL']['VALUE']):?>
														<div class="muted">
															<span class="icons-text schedule grey s25"><i class="fa"><?=CAllcorp2::showIconSvg("email colored", SITE_TEMPLATE_PATH."/images/svg/Email.svg");?></i> <span class="text"><?=$arItem['PROPERTIES']['EMAIL']['VALUE'];?></span></span>
														</div>
													<?endif;?>
												</div>
											</div>
