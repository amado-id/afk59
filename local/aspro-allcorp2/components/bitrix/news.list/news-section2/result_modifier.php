...
if($arGoodsSectionsIDs){
	$arResult['SECTIONS'] = CCache::CIBLockSection_GetList(array('SORT' => 'ASC', 'NAME' => 'ASC', 'CACHE' => array('TAG' => CCache::GetIBlockCacheTag($arParams['IBLOCK_ID']), 'GROUP' => array('ID'), 'MULTI' => 'N')), array('ID' => $arGoodsSectionsIDs, 'IBLOCK_ID' => $arParams['IBLOCK_ID']), false, array('ID', 'IBLOCK_ID','DESCRIPTION', 'PICTURE', 'DETAIL_PICTURE', 'UF_TOP_SEO'));
}
