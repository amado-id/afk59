				...
				<div class="items row">
					...
					<?endif;?>
						...
						<?foreach($arResult['ITEMS'] as $arItem):?>
							...
							<?endif;?>
						<?endforeach;?>
                        <a href="<?=SITE_DIR.$arParams['RIGHT_LINK']?>" class="btn button callback-form__button blue"><?=$arParams['RIGHT_TITLE'];?></a>
					</div>
					</div>
				</div>
			</div>
