								...
								<div class="text childs">
									<ul>
										<?foreach($arItem['CHILD'] as $arSubItem):?>
											<li><a class="colored" href="<?=($arSubItem['SECTION_PAGE_URL'] ? $arSubItem['SECTION_PAGE_URL'] : ((is_array($arSubItem['DETAIL_PAGE_URL']))?current($arSubItem['DETAIL_PAGE_URL']):$arSubItem['DETAIL_PAGE_URL']) );?>"><?=$arSubItem['NAME']?></a></li>
										<?endforeach;?>
									</ul>
								</div>
							<?endif;?>
