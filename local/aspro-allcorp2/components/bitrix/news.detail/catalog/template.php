				...
				<div class="col-md-<?=(($arParams['NARROW'] == 'Y') ? 7 : 6);?> col-sm-6">
					<div class="row galery">
						<div class="inner zomm_wrapper-block">
							...
							<div class="flexslider s_<?=$countAll;?> color-controls dark-nav2 top-bigs" data-slice="Y" id="slider" data-plugin-options='{"animationLoop": true, "slideshow": false, "counts": [1, 1, 1]}'>
				...
				<div class="info" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
					...
					<?if($arParams['NARROW'] == 'Y'):?>
						<?if(strlen($arResult['FIELDS']['PREVIEW_TEXT']) && !$bShowTopBanner):?>
							...
							<?if(strlen($arResult['FIELDS']['DETAIL_TEXT']) && false):?>
						...
						<div class="bottom-wrapper">
							<div class="bottom-wrapper-inner">
								...
								<?// Информация о кредите в карточке товара 08.12.2020?>
								<div class="wrapper-info-about-credit">
									<div>
										<p>
										<?$APPLICATION->IncludeComponent(
											...
											Array(
												...
												"EDIT_TEMPLATE" => "",
												"PATH" => SITE_DIR."include/catalog/info_about_credit.php"
											)
										);?>
										</p>
									</div>
