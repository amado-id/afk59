...
<?if($isIndex = CSite::inDir(SITE_DIR."index.php")):?>
	...
	<?$bCompanyOpt = ($bActiveTheme || (!$bActiveTheme && $arTheme["INDEX_TYPE"]["SUB_PARAMS"][$indexType]["COMPANY_INDEX"]["VALUE"] == 'Y'));?>
	<?$bCompanyOptClass = ($arTheme["INDEX_TYPE"]["SUB_PARAMS"][$indexType]["COMPANY_INDEX"]["VALUE"] == 'Y' ? '' : 'hidden');?>
