				...
				<?if($bTeasersIndex):?>
					<div class="drag-block container works-plan <?=$optionCode?> <?=$bTeasersIndexClass;?>" data-class="<?=$optionCode?>_drag" data-order="<?=++$key;?>">
                        <div class="maxwidth-theme">
                            ...
                            <div class="works-plan__list row">
                                <div class="works-plan__one col-sm-6 col-xs-12">
                                    <img src="<?=SITE_TEMPLATE_PATH?>/images/works01.png" alt="" />
                                    <span>Бесплатный замер</span>
                                </div>
                                <div class="works-plan__one col-sm-6 col-xs-12">
                                    <img src="<?=SITE_TEMPLATE_PATH?>/images/works02.png" alt="" />
                                    <span>Быстрый расчет</span>
                                </div>
                                <div class="works-plan__one col-sm-6 col-xs-12">
                                    <img src="<?=SITE_TEMPLATE_PATH?>/images/works03.png" alt="" />
                                    <span>Комплектация за 1 день</span>
                                </div>
                                <div class="works-plan__one col-sm-6 col-xs-12">
                                    <img src="<?=SITE_TEMPLATE_PATH?>/images/works04.png" alt="" />
                                    <span>Доставка</span>
                                </div>
                                <div class="works-plan__one col-sm-6 col-xs-12">
                                    <img src="<?=SITE_TEMPLATE_PATH?>/images/works05.png" alt="" />
                                    <span>Услуги по монтажу</span>
                                </div>
                            </div>
                        </div>
					</div>
