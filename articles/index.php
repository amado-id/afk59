...
$APPLICATION->SetPageProperty("description", "Статьи и комментарии от специалистов «Академии фасада и кровли» об особенностях строительных материалов, нюансах монтажа фасада, кровли и заборов");
